...
class ListItem extends Component {
    render() {
        if (this.props.item.pairID !== this.props.item.userID && this.props.item.userID !== this.props.item.selfID) {
                ...
                return (
                    <TouchableHighlight onPress={this.props.onPress}>
                        <View style={styles.li}>
                            <Text style={styles.liText}>{this.props.item.pairID + this.props.item.userDisplayName + ': ' + this.props.item.title}</Text>
                        </View>
                    </TouchableHighlight>
                );
